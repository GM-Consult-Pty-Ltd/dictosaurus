...
/// In grammar, a part of speech or part-of-speech is a category of words that
...
enum PartOfSpeech {
  ...
  /// or concrete entity (concrete noun: e.g. house); a person (police officer,
  /// Michael), place (coastline, London), thing (necktie, television),
  ...
  /// A word denoting an action(walk), occurrence (happen), or state of being
  /// (be).
  ///
  ...
  /// considered by some grammarians to be a type of adjective or sometimes
  /// the term 'determiner' (a broader class) is used.
  article
}
